    ...
    public static  void main() {
        ...
        while (done == false){ // when code is unifinsed...
            ...
            if (demand == 7) {
                ...
                studlist.deleteStudent(name); //calls method to delete student
                if (studlist.deleteStudent(name)== true) { //if student has been deleted
                ...
                if(option == 1){//if they want to edit by student number 
                    ...
                    double GPA = demand32.nextDouble(); 
                    int number =0; 
                    if (studlist.editStudentList(number, name, GPA) == true) { //if it has been updated
                        System.out.println ("Student edited"); 
                ...
                studlist.clearList();//uses method in ArrayList Class
                System.out.println("List Cleared");
                System.out.println();
            } else if (demand == 5) { // print student list
                System.out.println ("Here is student list: "); 
                System.out.println (); 
                studlist.printStudentList(); //ArrayList method
                System.out.println();
